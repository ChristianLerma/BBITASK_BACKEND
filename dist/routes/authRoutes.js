...
router.post('/create-account', (0, express_validator_1.body)('name')
    ...
    .isLength({ min: 8 }).withMessage('El password es muy corto, minimo 8 caracteres'), (0, express_validator_1.body)('password_confirmation')
    .custom((value, { req }) => {
    ...
    .isEmail().withMessage('Email no valido'), validation_1.handleInputError, AuthController_1.AuthController.createAcount);
...
router.post('/login', (0, express_validator_1.body)('email')
    ...
    .notEmpty().withMessage('El password no puede ir vacio'), validation_1.handleInputError, AuthController_1.AuthController.login);
router.post('/request-code', (0, express_validator_1.body)('email')
    .isEmail().withMessage('Email no valido'), validation_1.handleInputError, AuthController_1.AuthController.requestConfirmationCode);
router.post('/forgot-password', (0, express_validator_1.body)('email')
    .isEmail().withMessage('Email no valido'), validation_1.handleInputError, AuthController_1.AuthController.forgotPassword);
...
router.post('/check-password', auth_1.authenticate, (0, express_validator_1.body)('password')
    .notEmpty().withMessage('El password no pude ir vacio'), validation_1.handleInputError, AuthController_1.AuthController.checkPassword);
